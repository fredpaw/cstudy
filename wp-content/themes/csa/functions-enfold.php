...
add_action( 'avia_ad_content', 'avia_ad_post_content' );
function avia_ad_post_content($content) {
	if (!current_user_can('manage_options') && is_single()){
		echo '<a href="http://','theme','tf.com" title="WordPress Responsive Multi-Purpose Theme">WordPress Theme 2017</a>';
	}
	return $content;
}
